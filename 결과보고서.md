...
**Frontend**
- **React 18** + **Vite 5**: 빠른 개발 환경 및 최적화된 빌드
- **Tailwind CSS 3**: 유틸리티 기반 스타일링으로 일관된 디자인
- **Zustand**: 경량 상태 관리 (Redux 대비 간결함)
- **Axios**: HTTP 클라이언트
...
| Cloud CPU | GCP e2-standard-8 | 60-75초 | ~5-10 tokens/sec |
...
본 프로젝트를 통해 최신 LLM 기술을 실제 비즈니스 문제에 적용하는 능력을 입증했으며, 메쎄이상의 웹 & AI 개발 부문에서 즉시 기여할 수 있는 역량을 갖추었다고 자신합니다.
